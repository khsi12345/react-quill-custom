...
/***/ function(module, exports) {
	...
	*/
	...
	var config = {
	  scope: _parchment2.default.Scope.INLINE,
	  whitelist: ["dotum", "gullim", "batang", "NanumGothic"]
	};
	...
	var SizeClass = new _parchment2.default.Attributor.Class('size', 'ql-size', {
	  scope: _parchment2.default.Scope.INLINE,
	  whitelist: ["8", "9", "10", "11", "12", "14", "18", "24", "36"]
	});
	var SizeStyle = new _parchment2.default.Attributor.Style('size', 'font-size', {
	  scope: _parchment2.default.Scope.INLINE,
	  whitelist:["10.6px","12px","13.3px","14.6px","16px","18.6px","24px","32px","48px"]
	});
	...
	var FONTS = ["dotum", "gullim", "batang", "NanumGothic"];
	
	var HEADERS = ['1', '2', '3', false];
	
	var SIZES = ["8", "9", "10", "11", "12", "14", "18", "24", "36"];
	...
	var defaultItems = [
		...
		{ label:'Formats', type:'group', items: [
			{ label:'Font', type:'font', items: [
				{ label:'돋움체',  value:'dotum', selected:true },
				{ label:'굴림체',  value:'gullim'},
				{ label:'바탕체',       value:'batang' },
				{ label:'나눔고딕체',   value:'NanumGothic' }
			]},
