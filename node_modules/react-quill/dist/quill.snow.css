...
.ql-editor .ql-video.ql-align-left {
  text-align: left;
  margin: 0 0 0 auto;
}
...
.ql-font span[data-label="dotum"]::before {
  font-family: Dotum, "돋움", sans-serif;
}

.ql-font span[data-label="gullim"]::before {
  font-family: "굴림", Gulim, sans-serif;
}

.ql-font span[data-label="batang"]::before {
  font-family: 'KoPub Batang';
}

.ql-font span[data-label="NanumGothic"]::before {
...
.ql-snow .ql-picker.ql-header .ql-picker-label[data-label]:not([data-label='dotum'])::before,
.ql-snow .ql-picker.ql-font .ql-picker-label[data-label]:not([data-label='gullim'])::before,
.ql-snow .ql-picker.ql-size .ql-picker-label[data-label]:not([data-label='batang'])::before,
.ql-snow .ql-picker.ql-header .ql-picker-item[data-label]:not([data-label='NanumGothic'])::before,
...
.ql-snow .ql-picker.ql-header .ql-picker-item[data-value="8"]::before {
  font-size: 10.6px;
}

.ql-snow .ql-picker.ql-header .ql-picker-item[data-value="9"]::before {
  font-size: 12px;
}

.ql-snow .ql-picker.ql-header .ql-picker-item[data-value="10"]::before {
  font-size: 13.3px;
}

.ql-snow .ql-picker.ql-header .ql-picker-item[data-value="11"]::before {
  font-size: 14.6px;
}

.ql-snow .ql-picker.ql-header .ql-picker-item[data-value="12"]::before {
  font-size: 16px;
}

.ql-snow .ql-picker.ql-header .ql-picker-item[data-value="14"]::before {
  font-size: 18.6px;
}

.ql-snow .ql-picker.ql-header .ql-picker-item[data-value="18"]::before {
  font-size: 24px;
}

.ql-snow .ql-picker.ql-header .ql-picker-item[data-value="24"]::before {
  font-size: 32px;
}

.ql-snow .ql-picker.ql-header .ql-picker-item[data-value="36"]::before {
  font-size: 48px;
}
